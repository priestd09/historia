...
<ul class="nav">
  <li class="<?php echo isActive($pageName,"")?>"><a href="<?php echo base_url(); ?>"><i class="icon-home"></i> Home</a></li>
  <li class="<?php echo isActive($pageName,"contact")?>"><a href="<?php echo base_url(); ?>"><i class="icon-envelope"></i> Contact Us</a></li>
</ul>
